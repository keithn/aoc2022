...
public class Day9
{
    ...
    public static void Solve()
    {
        ...
        IEnumerable<Point> TailTrail(IEnumerable<string> lines, List<Point> rope)
        {
            var tailTrail = new List<Point>();
            foreach (var line in lines)
            {
                ...
                for (int _ = 0; _ < count; _++)
                {
                    ...
                    for (var k = 1; k < rope.Count; k++)
                    {
                        ...
                        if (k == rope.Count - 1) tailTrail.Add(rope[k]);
                    }
                }
            }
            return tailTrail.Distinct();
        }
